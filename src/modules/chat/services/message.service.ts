...
/**
 * Infinite query for paginated messages in a chat
 * Uses cursor-based pagination (created_at)
 */
import { useInfiniteQuery } from "@tanstack/react-query";
import { getPaginatedMessagesForChat } from "../repositories/message.repository";

export function usePaginatedMessagesForChat(chatId: string, pageSize: number = 20) {
  ...
  >({
    ...
    queryFn: async (context) =>
      getPaginatedMessagesForChat(chatId, pageSize, (context.pageParam as string | null) ?? null),
